...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{../fuentes/catastro/plano-catastral.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{../fuentes/ubicacion/ubicacion-satelital.png}
...
La arquitectura base se toma de los tres layouts canonicos declarados en el manifiesto del proyecto. Los ambientes reconocidos son los siguientes:
...
C4 & Alumbrado del segundo piso & Atiende dormitorio principal (2), dormitorio 3 (1), sala/hall (1), bano (1) y escalera (1): 6 puntos de luz. \\
C5 & Tomacorrientes del segundo piso & Atiende dormitorios (5), sala/hall (2) y bano (1): 8 puntos dobles. \\
C6 & Alumbrado del tercer piso & Atiende dormitorio 4 (1), dormitorio 5 (1), dormitorio 6 (1), pasadizo (1), bano (1) y escalera (1): 6 puntos de luz. \\
C7 & Tomacorrientes del tercer piso & Atiende dormitorio 4 (2), dormitorio 5 (2), dormitorio 6 (2), pasadizo (1) y bano (1): 8 puntos dobles. \\
\bottomrule
\end{tabularx}
\end{table}
...
Se propone ubicar el tablero general TG-01 en el primer piso, cerca del ingreso y en zona accesible. El medidor se representa de forma referencial en fachada o ingreso. Por la existencia de tres niveles, se consideran dos tableros de distribucion secundarios: TD-02 asociado al segundo piso y TD-03 asociado al tercer piso.

\begin{itemize}
  \item \textbf{TG-01:} tablero general de corte y proteccion principal del primer piso.
  \item \textbf{TD-02:} tablero de distribucion para el segundo nivel.
  \item \textbf{TD-03:} tablero de distribucion para el tercer nivel.
